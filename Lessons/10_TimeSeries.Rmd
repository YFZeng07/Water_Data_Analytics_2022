...
> aggregation: aggregate daily data for monthly

> subsampling: eg1. part of the data for modeling and the rest to test the model. eg2. too much data so subsample at different frequency (take 1 day every month for monthly data)
