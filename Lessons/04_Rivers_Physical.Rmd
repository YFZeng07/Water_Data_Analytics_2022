...
EnoDischarge <- readNWISdv(siteNumbers = "02085070",
                     ...
                     startDate = "", 
                     endDate = "2021-09-30") 
#USGS water year a year starts on 10/1 and ends on 9/30
...
EnoDischarge <- EnoDischarge %>%
  ...
  #origin: there are other reginal water years
  filter(WaterYear != "1963") #water year column is a factor so need "" ↓
...
#factor to numeric: need to convert to character first
