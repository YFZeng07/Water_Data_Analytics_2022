...
#drop_na can drop NAs from a specific column

#States have various sample numbers
#The slope and interception are different
```
...
LAGOSMN <- LAGOSjoined %>%
  ...
  filter(state_name == "Minnesota" & Month > 5 & Month < 10 & Year >= 1990) %>%
